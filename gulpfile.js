...
var damutek = {
    ...
    src: {
        html: 'src/*.html',
        js: 'src/js/damutek.js',
        style: 'src/scss/damutek.scss',
        img: 'src/img/**/*.*',
        fonts: 'src/fonts/**/*.*'
    },
    watch: {
...
gulp.task('html:build', function () {
    gulp.src(damutek.src.html)
        .pipe(plugins.rigger())
        .pipe(gulp.dest(damutek.build.html))
...
gulp.task('watch', function(){
    plugins.watch([damutek.watch.html], function(event, cb) {
        gulp.start('html:build');
    });
    plugins.watch([damutek.watch.style], function(event, cb) {
        gulp.start('style:build');
    });
    plugins.watch([damutek.watch.js], function(event, cb) {
        gulp.start('js:build');
    });
    plugins.watch([damutek.watch.img], function(event, cb) {
        gulp.start('image:build');
    });
    plugins.watch([damutek.watch.fonts], function(event, cb) {
